...
if(move_uploaded_file($_FILES["itemimages"]["tmp_name"],$target_file))
    ...
    $query=mysqli_query($con, "insert into tblcategory(CategoryName,CategoryImage)values('$categoryname','$target_file')");
              ...
              <div class="ibox-content">
                <p style="font-size:16px; color:red;"> <?php if($msg){
					...
					<div class="form-group row"><label class="col-sm-2 col-form-label">Category Name</label>
                       <div class="col-sm-10"><input type="text" class="form-control" name="categoryname" required="true"></div>
                    </div>
