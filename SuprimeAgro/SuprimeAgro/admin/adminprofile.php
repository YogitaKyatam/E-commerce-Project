...
if(isset($_POST['submit']))
  {
    ...
    $email=$_POST['email'];
     ...
     $query=mysqli_query($con, "update tbladmin set AdminName ='$adminname', MobileNo='$mobno', Email='$email' where ID='$adminid'");
    if ($query) {
 ...
 <form id="submit" action="#" class="wizard-big" method="post" name="submit">
       <fieldset>
        ...
        <div class="form-group row"><label class="col-sm-2 col-form-label">MobileNumber:</label>
           <div class="col-sm-10">
             <input type="text" class="form-control" name="mobilenumber" required="true"value="<?php  echo $row['MobileNo'];?>">
               </div>
        </div>
