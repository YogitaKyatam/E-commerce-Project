     ...
     <?php include_once('includes/leftbar.php');?>
        ...
        <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="ibox ">
                            <div class="ibox-title">
                                <?php $query1=mysqli_query($con,"Select * from  tblCustomer where FinalStatus='order received'");
                    ...
                    <div class="col-lg-4">
                        <div class="ibox ">
                            <div class="ibox-title">
                                <?php $query2=mysqli_query($con,"Select * from  tblCustomer where FinalStatus ='Order Confirmed'");
        ...
        <div class="col-lg-4">
                        <div class="ibox ">
                            <div class="ibox-title">
                                <?php $query3=mysqli_query($con,"Select * from  tblCustomer where FinalStatus ='Product being Prepared'");
									$beigpre=mysqli_num_rows($query3);
								?>
								<a class="text-muted text-uppercase m-b-20" href="productbeingprepared.php" style="font-size: 20px"><strong>Product being Prepared</strong></a>																   
                            </div>
                            <div class="ibox-content">
                                <h1 class="no-margins"><?php echo $beigpre;?></h1>
                                <small>Product being Prepared</small>
                            </div>
                        </div>
        </div>
                    <div class="col-lg-4">
                        <div class="ibox ">
                            <div class="ibox-title">
                                <?php $query4=mysqli_query($con,"Select * from tblCustomer where FinalStatus ='Product Pickup'");
								$foodpickup=mysqli_num_rows($query4);
								?>
							  <a class="text-muted text-uppercase m-b-20" href="product-pickup.php" style="font-size: 20px"><strong>Product Pickup</strong></a>
                    ...
                    <div class="col-lg-4">
                        <div class="ibox ">
                            <div class="ibox-title">
                                <?php $query5=mysqli_query($con,"Select * from  tblCustomer where finalstatus ='Product Delivered'");
								$fooddel=mysqli_num_rows($query5);
								?>
							  <a class="text-muted text-uppercase m-b-20" href="product-delivered.php" style="font-size: 20px"><strong>Total Product Deliver</strong></a>
                            </div>
                            <div class="ibox-content">
