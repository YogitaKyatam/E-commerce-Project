...
if(move_uploaded_file($_FILES["itemimages"]["tmp_name"],$target_file))
    ...
    $query=mysqli_query($con, "insert into tbladvertise(AdvertiseName,AdvertiseImage)values('$advertisename','$target_file')");
            ...
            <div class="ibox">
              <div class="ibox-content">
                <p style="font-size:16px; color:red;"> <?php if($msg){
					...
					<div class="form-group row"><label class="col-sm-2 col-form-label">Advertisename Name</label>
                       <div class="col-sm-10"><input type="text" class="form-control" name="advertisename" required="true"></div>
                    </div>
